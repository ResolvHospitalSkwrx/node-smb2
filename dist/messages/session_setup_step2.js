...
exports.default = (0, message_1.default)({
    generate(connection) {
        return new smb2_message_1.default({
            ...
            request: {
                Buffer: ntlm.encodeType3(connection.username, connection.ip, connection.domain, connection.nonce, connection.password),
            },
        });
    },
});
//# sourceMappingURL=session_setup_step2.js.map